          ...
          <div className={styles.grid}>
            ...
            <div className={styles.newsletterCol}>
              ...
              <div className={styles.socialLinks}>
                <a href="https://facebook.com/sihamed" aria-label="Facebook">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                  </svg>
                </a>
                <a href="https://twitter.com/sihamed" aria-label="Twitter">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                </a>
                <a href="https://instagram.com/sihamed" aria-label="Instagram">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <a href="https://linkedin.com/company/sihamed" aria-label="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://youtube.com/sihamed" aria-label="YouTube">
                  <svg viewBox="0 0 24 24" fill="currentColor">
